 ...
 * This class holds the various utility methods being used to generate the certificates.
 */
...
public class CertificateUtils {
	...
	// hex table used for the decoding of certificate base64
	...
	/**
	 * Method to get public key from the modulus and exponent obtained from the jwks
	 * 
	 * @param modulusB64u
	 * @param exponentB64u
	 * @return publicKey
	 ...
	 */
	private PublicKey getPublicKey(String modulusB64u, String exponentB64u)
	...
	/**
	 * Create and return a public key from modules
	 * 
	 * @param key
	 * @return
	 */
	public String isVerified(JSONObject key) {
		String exponentB64u = (String) key.get("e");
		String modulusB64u = (String) key.get("n");
		PublicKey publicKey = null;
		try {
			publicKey = getPublicKey(modulusB64u, exponentB64u);
